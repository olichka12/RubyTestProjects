...
MESSAGE_STOP = '/stop'
MESSAGE_SET = '/set'
MESSAGE_WEATHER_DESCRIPTION = 'Я запитаю тебе місто, у якому ти хочеш подивитися погоду'
MESSAGE_SET_DESCRIPTION = 'Я запитаю тебе місто і годину, у котрій ти захочеш отримати сповіщення про прогоду'
